//Credit for bloom code goes to Christopher Webb
//found at http://www.openprocessing.org/sketch/30110
...
public class BloomPProcess
{
  ...
  private int       BloomThreshold   = 0; //the minimum brightness that will be "bloomed"
  private int       BloomRadius      = 5;   //the radius of the bloom
